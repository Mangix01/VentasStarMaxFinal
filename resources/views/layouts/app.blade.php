...
<head>
    ...
    <meta name="description" content="Sistema de ventas para la tienda STARMAX">
    ...
    <!-- Estilos para manejar el data table -->
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Inicio de Contenido Principal de Módulo -->
                <div class="container-fluid">
                    @yield('content')
                </div>
                <!-- Fin de Contenido Principal de Módulo -->
